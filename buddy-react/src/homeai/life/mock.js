...
const HOUSEHOLD = {
  ...
  members: [
    ...
    },
    {
      id: "m-parent",
      name: "Dad",
      relationship: "Parent (periodic care)",
      initials: "BR",
      color: PAL.green,
      manages: [],
      info: [
...
const NEEDS_ATTENTION = [
  {
    ...
    category: "family",
    accent: PAL.amber,
    tag: "Confirm inference",
    title: "Priya may prefer Italian restaurants",
    sub: "Inferred from 3 chats · confirm before I use it",
  ...
  },
  {
    ...
    accent: PAL.blue,
    tag: "Gentle nudge",
    title: "You normally call Dad on Sunday",
    sub: "The last two Sundays don't show a call",
  ...
  },
  {
    ...
    accent: PAL.green,
    tag: "Care task",
    title: "Dad's cardiologist follow-up is coming up",
    sub: "I can turn this into a full care journey",
...
const CAR = {
  ...
  serviceDue: "~400 km (est. 2 weeks)",
  estAnnualCost: "₹42,000",
  insurance: "Renews Oct 2026",
  compliance: "Pollution cert valid to Dec 2026",
  responsible: "You",
  serviceSlots: [
...
const SAFE_TO_SPEND = {
  ...
  rows: [
    ...
    { label: "Planned purchases", amount: 4e3, op: "sub" },
    { label: "Safety buffer", amount: 8e3, op: "sub" }
  ],
  total: 48200,
...
const FORECAST_7D = [
  { day: "16", balance: 72400, low: false },
  { day: "18", balance: 66e3, low: false },
  { day: "20", balance: 58e3, low: false },
  { day: "21", balance: 4e4, low: false },
  { day: "22", balance: 15440, low: true },
  { day: "25", balance: 78e3, low: false },
  { day: "28", balance: 7e4, low: false }
];
const SCENARIO = {
  id: "sc-trip",
  question: "Can I spend ₹30,000 on a trip next month?",
...
const FINANCIAL_ACTION = {
  ...
  when: "Now",
  fees: "None",
  cancellation: "Can't be reversed once sent",
  safeToSpendImpact: "−₹24,560 → ₹23,640",
  permission: "One-time · this amount · this recipient only"
};
const SHARED_WORKFLOWS = [
  {
    id: "sw-eldercare",
    title: "Elder-care rota",
    purpose: "Coordinate Dad's visits and daily medicines.",
    owner: "You",
    pendingInvites: 0,
    participants: [
...
const PERMISSION_LABELS = {
  ...
  execute_after_confirm: "Execute after confirmation",
  execute_reversible: "Execute reversible only",
