...
const MODE_CONFIG = {
  morning: {
    label: "Morning",
    reasonHint: "Plan, commute and first meeting up top.",
  ...
  workday: {
    label: "Workday",
    reasonHint: "Current work, next meeting and blockers first.",
  ...
  evening: {
    label: "Evening",
    reasonHint: "Unfinished work, travel home and family.",
  ...
  weekend: {
    label: "Weekend",
    reasonHint: "Life, family, wellbeing and money.",
    order: ["personal", "protect", "prepare", "delegate", "prioritise", "move"],
    hidden: ["move", "delegate"],
    reducedMotion: false,
    summaryTone: "Off the clock — a lighter, life-first view."
  },
  travel: {
    label: "Travel",
    reasonHint: "Itinerary, documents and logistics first.",
  ...
  high_stress: {
    label: "High stress",
    reasonHint: "Three critical cards, one clear next step, calmer motion.",
    order: ["prioritise", "personal", "protect", "prepare", "move", "delegate"],
    hidden: ["move", "delegate", "prepare"],
    reducedMotion: true,
    maxCards: 3,
    summaryTone: "Just the essentials. Everything else can wait."
  }
};
function currentContext(signals, overrideStress) {
...
const ALL_MODES = ["morning", "workday", "evening", "weekend", "travel", "high_stress"];
export {
  ALL_MODES,
  MODE_CONFIG,
  currentContext,
