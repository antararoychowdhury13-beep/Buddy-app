/** Inline SVG icons matching the Buddy V1 stroke style. */
import type { Domain } from "../models";

function svg(paths: string, opts: { fill?: boolean; sw?: number } = {}): string {
...
export const DOMAIN_META: Record<Domain, { color: string; bg: string; icon: string; label: string }> = {
