...
const USER = {
  id: "u-antara",
  name: "Antara Roychowdhury",
  role: "Design Manager",
  email: "antara@company.com",
  initials: "AR"
};
const PARTICIPANTS = [
...
const MEETING = {
  id: "m-phoenix",
  title: "Project Phoenix Weekly Review",
  date: "19 July 2026",
  durationMins: 48,
  platform: "Microsoft Teams",
  scope: "Work → Project Phoenix",
...
const PRIMARY_COMMAND = "Buddy, record this meeting, prepare the MOM, send after I approve, create Jira tasks for every action item, update the project timeline and follow up with owners before their deadlines.";
export {
  ACTION_ITEMS,
  ASSUMPTIONS,
  CONSENT,
