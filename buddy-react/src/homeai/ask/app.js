...
import { clear, el, toast, openSheet } from "../ui/dom";
import { ICONS } from "../ui/icons";
import { MEETING, PALETTE, PRIMARY_COMMAND, USER } from "./mock";
import { AskStore } from "./store";
import { openPlanFlow, openConsent, openMomWorkspace, openCompletion, openMonitoring, openActivity } from "./sheets";
const MODES = [
...
class AskApp {
  constructor(root) {
    __publicField(this, "store", new AskStore());
    __publicField(this, "root");
    __publicField(this, "composerValue", "");
    this.root = root;
    this.render();
  }
  render() {
  ...
  contextBar() {
    ...
    return el("section", { class: "ctx-bar", "aria-label": "Active context" }, [
      el("button", { class: "ctx-item", type: "button", onClick: () => this.openScopePicker() }, [
        el("span", { class: "ctx-k" }, ["Scope"]),
        el("span", { class: "ctx-v" }, [c.scopeLabel])
      ]),
      ...
      el("button", { class: "ctx-item", type: "button", onClick: () => this.openModePicker() }, [
        el("span", { class: "ctx-k" }, ["Mode"]),
        el("span", { class: "ctx-v cap" }, [c.mode])
      ]),
  ...
  emptyState() {
    ...
    return el("div", { class: "ask-empty" }, [
      ...
      el("div", { class: "prompt-grid" }, prompts.map(([label, cmd]) => el("button", { class: "prompt-card", type: "button", onClick: () => this.submit(cmd) }, [
        el("span", { class: "prompt-ic", html: ICONS.spark }),
        el("span", {}, [label])
      ]))),
  ...
  statusCard(k, v, icon, onClick) {
    return el("button", { class: "status-card", type: "button", onClick }, [
      el("span", { class: "ic", html: icon }),
      el("div", {}, [el("div", { class: "status-v" }, [v]), el("div", { class: "status-k" }, [k])])
    ]);
  }
  messageEl(m) {
  ...
  composer() {
    const input = el("textarea", {
      ...
      onInput: (e) => {
        this.composerValue = e.target.value;
        const t = e.target;
        t.style.height = "auto";
