...
const sid = () => `t-step-${++sq}`;
function step(p) {
  return { id: sid(), executionStatus: "suggested", undoAvailable: p.reversible, ...p };
}
const ADAPTERS = [
  ...
  return [
    {
      id: "s-focus",
      type: "protect_focus",
      title: "Protect 3:00–5:15 PM for focused work",
      ...
      originalTime: "Unprotected",
      proposedTime: "3:00–5:15 PM held",
      affectedPeople: [],
      confidence: "high",
      confidenceReason: "From your calendar (3 min old) and saved focus preference.",
      sources: ["calendar", "prefs"],
      reversible: true,
      riskLevel: "low",
      permissionRequired: "calendar.block_focus",
      minutesRecovered: 70,
      safe: true,
      status: "suggested",
    ...
    },
    {
      id: "s-buffer",
      type: "add_buffer",
      title: "Add a 10-min buffer after the Stakeholder Sync",
      ...
      originalTime: "11:30 AM hard stop",
      proposedTime: "10-min buffer to 11:40",
      affectedPeople: [],
      confidence: "high",
      confidenceReason: "Overrun history from your calendar.",
      sources: ["calendar"],
      reversible: true,
      riskLevel: "low",
      permissionRequired: "calendar.block_focus",
    ...
    },
    {
      ...
      originalTime: "12:00 PM today",
      proposedTime: "Thu 12:00 PM",
      affectedPeople: ["Vendor organiser"],
      confidence: "medium",
      confidenceReason: "Organiser offered alternates by email; Thursday not yet confirmed.",
      sources: ["calendar", "email"],
      reversible: true,
      riskLevel: "medium",
      permissionRequired: "calendar.move_internal",
      minutesRecovered: 30,
      safe: false,
      status: "suggested",
    ...
    },
    {
      id: "s-prep",
      type: "add_prep",
      title: "Add a 30-min prep block before the Roadmap Review",
      ...
      originalTime: "No prep",
      proposedTime: "1:30–2:00 PM prep",
      affectedPeople: [],
      confidence: "high",
      confidenceReason: "Jira delivery dates vs the deck's last-modified time.",
    ...
    },
    {
      ...
      originalTime: "On your list",
      proposedTime: "Buddy drafts, you review",
      affectedPeople: [],
      confidence: "high",
      confidenceReason: "All sprint issues have final states in Jira.",
      sources: ["jira"],
      reversible: true,
      riskLevel: "low",
...
function buildTaskPlan(clarified) {
  return {
    taskId: "t1",
    title: "Review API spec (BUD-231)",
...
function buildRecoveryPlans() {
  const s = (description, targetSystem, riskLevel, reversible, permissionRequired, preview, draftMessage) => step({ description, targetSystem, riskLevel, reversible, permissionRequired, preview, draftMessage });
  return [
    {
      id: "r-lunch",
      name: "Protect lunch",
      trigger: "Stakeholder Sync overran 25 min",
      description: "Keep your lunch hour intact and move the sprint summary to tomorrow morning.",
      commitmentsProtected: ["Lunch", "Aarav's pickup"],
      commitmentsMoved: ["Sprint summary → tomorrow 9:30 AM"],
      peopleAffected: [],
      personalImpact: "Family pickup stays safe.",
      expectedFinish: "6:15 PM",
      completionBand: "Likely (~78%)",
      confidence: "high",
      permissionRequired: "calendar.block_focus",
    ...
    {
      id: "r-deliver",
      name: "Protect deliverables",
      trigger: "Stakeholder Sync overran 25 min",
      description: "Shorten lunch by 10 minutes and keep the sprint summary today.",
      commitmentsProtected: ["Sprint summary", "Aarav's pickup"],
      commitmentsMoved: ["Lunch −10 min"],
      peopleAffected: [],
      personalImpact: "Family pickup stays safe; lunch is a bit shorter.",
      expectedFinish: "6:20 PM",
      completionBand: "Likely (~81%)",
      confidence: "high",
      permissionRequired: "calendar.block_focus",
    ...
    {
      id: "r-delegate",
      name: "Delegate to Buddy",
      trigger: "Stakeholder Sync overran 25 min",
      description: "Buddy drafts the sprint summary from the board; you review it later.",
      commitmentsProtected: ["Lunch", "Focus block", "Aarav's pickup"],
      commitmentsMoved: [],
      peopleAffected: [],
      personalImpact: "Nothing personal is touched.",
      expectedFinish: "6:05 PM",
      completionBand: "Very likely (~88%)",
      confidence: "medium",
      permissionRequired: "project.read",
