...
export const PRIMARY_COMMAND = "Buddy, record this meeting, prepare the MOM, send after I approve, create Jira tasks for every action item, update the project timeline and follow up with owners before their deadlines.";
